...
export default function CaptureCoach({ hasImage, hasText, extraction, onFocus, disabled = false, pendingPreview = false }) {
  return <section className="capture-coach" aria-label="Capture guidance">
    ...
    {hasImage && !hasText && <p>Select one complete declaration below to read a close-up first, or use “Run browser OCR” for the whole package. Selection never supplies a heading or an answer to the OCR engine.</p>}
