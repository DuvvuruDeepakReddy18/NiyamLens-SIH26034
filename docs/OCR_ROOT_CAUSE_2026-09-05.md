...
**Live release:** [NiyamLens](https://niyamlens-sih26034.vercel.app/), application source `a498a5d82e5f1e9630bea51b660dee757da888dd`, pushed to `codex/managed-cloud-release`. [CI run 33977073670](https://github.com/DuvvuruDeepakReddy18/NiyamLens-SIH26034/actions/runs/33977073670) passed clean install, tests, build, source/build model hashes and production dependency audit. Vercel deployment `dpl_4X9qPWM83qoWa2C3SMm6Z7pmQaXi` was promoted after production managed-mode validation, readiness and anonymous-denial checks.

At 16:15 UTC, the public site served `/assets/index-Cg8OAE2v.js`, SHA-256 `f0d81ac6a5cf967f22cda7b98bf1b7d59f5f40eda05f0f7774f442646b844f7e`; home/bundle/health returned 200, health was ready, anonymous cases returned 401. Fresh signed-out Chrome verified this bundle and empty login controls at 1440px/390px without page errors or horizontal overflow. These are bounded public checks, not a new authenticated hosted OCR study or 15-minute monitoring window. [Compact release evidence](../reports/root-cause-release-2026-09-05/evidence.json) records the source-report digests and limits. Full local diagnostic reports are retained separately and are not published as independent human validation.
