...
## Current readiness — RC7 live, 5 September 2026

The [RC7 capture-first and review-integrity update](docs/RC7_RELEASE_2026-09-05.md) is live, source `3f9ef45`, CI-passed and publicly smoke-tested. It adds pre-OCR declaration selection, protected preview transitions, stale-review fixes and safer compound-token parsing. Version 0.4.5 / evaluation pack `LMPC-RC-2026.09-RC7`; 640 local regression tests pass. Recognition remains 1/10 directly and 6/10 with automated layout selection on eight known development photos—not blind accuracy. The RC6 records below are historical.
